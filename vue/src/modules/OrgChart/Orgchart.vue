  ...
  <div style="width: 100%">
    <div style="width: 100%; align-content: center">
      <ul class="nav nav-tabs">
        <li class="nav-item">
          <button class="nav-link active" v-on:click.prevent="getChartDataByCountry('US')">
            tab1
          </button>
        </li>
        <li class="nav-item">
          <button class="nav-link" v-on:click.prevent="getChartDataByCountry('UK')">
            tab2
          </button>
        </li>
        <li class="nav-item">
          <button class="nav-link" v-on:click.prevent="getChartDataByCountry('GB')">
            tab3
          </button>
        </li>
        <li class="nav-item">
          <button class="nav-link" v-on:click.prevent="getDataForChart('GE')">
            tab4
          </button>
        </li>
      </ul>
    ...
    <div style="align-content: center; width: 100%">
      <vo-basic :data="chartData" :verticalDepth="3"></vo-basic>
    </div>
  </div>
</template>
