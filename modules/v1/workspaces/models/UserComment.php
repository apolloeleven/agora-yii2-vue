    ...
    public function behaviors()
    {
        return array_merge(parent::behaviors(), [
            ...
            [
                ...
                'descriptions' => [
                    UserActivity::ACTION_INSERT => '{user} {action} on post "{content}"',
                    UserActivity::ACTION_UPDATE => '{user} {action} on post "{content}"',
                    UserActivity::ACTION_DELETE => '{user} {action} on post "{content}"',
                ],
                'data' => function(){
                    return [
